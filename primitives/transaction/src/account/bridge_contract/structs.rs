...
///
/// Used in [`Transaction::recipient_data`] for signaling transactions when
/// processing burns from other chains. This handles the path where funds
/// leave the bridge to be released to a user after they burned wrapped tokens
/// on another chain.
...
fn verify_transaction_signature(
    ...
    let tx = {
        ...
        tx_without_sig.recipient_data = OutgoingBridgeTransactionData::set_signature_on_data(
